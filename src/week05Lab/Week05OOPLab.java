...
public class Week05OOPLab {
	...
	public static void main(String[] args) {
		...
		Card myCard = new Card("Two", "Clubs", 2);
		...
		Map<String, List<Card>> dealtHands = dealCards(players);
		
		for (int i = 1; i <= players; i++) {
			String playerName = "Player " + i;
			System.out.println("\n" + playerName);
			System.out.println("--------");
			List<Card> hand = dealtHands.get(playerName);
			for (Card card : hand) {
				card.describe();
			}
		}
